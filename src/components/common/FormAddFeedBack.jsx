...
const FormAddFeedBack = ({ handleCloseModal }) => {
  ...
  return (
    <div className="StyledKirimFeedback">
      ...
      <p className="div">Masukkan data sesuai dengan data yang Anda masukkan ketika pendaftaran konsultasi</p>
      ...
      <Form>
        <Form.Group controlId="formNIK" className="form-group">
          ...
          <Form.Control type="text" placeholder="Masukkan NIK" className="form-control"/>
        </Form.Group>
        <Form.Group controlId="formNama" className="form-group">
          <Form.Label>Nama</Form.Label>
          <Form.Control type="text" placeholder="Masukkan Nama" className="form-control"/>
        </Form.Group>
        <Form.Group controlId="formPenilaian" className="form-group">
          <Form.Label>Penilaian</Form.Label>
          <Form.Control as="textarea" rows={3} placeholder="Masukkan Komentar" className="form-control"/>
        </Form.Group>
